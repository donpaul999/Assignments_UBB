...
@Entity
@Table(name = "Rental")
public class Rental extends BaseEntity<Long> implements From<String[]>, Into<String[]>, FromNode, IntoNode, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (this.clientId != rental.clientId) return false;
        if (!this.domainId.equals(rental.domainId)) return false;
        if (!this.startDate.equals(rental.startDate)) return false;
        return this.duration.equals(rental.duration);
    }
