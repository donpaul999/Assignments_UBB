...
public class HeapReadingExp implements Exp {
    ...
    public Type typeCheck(MyIDictionary<String, Type> typeEnv) throws MyException {
        ...
        if (typ instanceof RefType) {
            ...
            throw new MyException("HeapReading: the heap reading argument is not a Ref Type");
    }
    ...
    public IValue eval(MyIDictionary<String, IValue> symTable, IHeap<Integer,IValue> heap) throws MyException {
        ...
        if (val.getType() instanceof RefType) {
            ...
            if (content != null)
                return content;
            else throw new MyException("HeapReadingTC: The address doesn't exists in the heap");

        } else throw new MyException("HeapReadingTC: The value is not a Reference Value!");
    }
}
