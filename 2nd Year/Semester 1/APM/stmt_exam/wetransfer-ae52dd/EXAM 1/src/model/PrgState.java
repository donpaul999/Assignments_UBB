...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> exeStack, MyIDictionary<String, IValue> symTable, MyIList<IValue> out, IStmt originalProgram, FileTable<StringValue,BufferedReader> fileTable, IHeap<Integer,IValue> heap) {
