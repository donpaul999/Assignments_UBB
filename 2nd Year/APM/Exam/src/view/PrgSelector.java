...
public class PrgSelector {
    ...
    public MyList<IStmt> getStmtList() {
        ...
        IStmt example_8 = new CompStmt(new VarDeclStmt("a", new RefType(new IntType())),
                                        ...
                                        new CompStmt(new NewHeapStmt("b", new ValueExp(new IntValue(0))),
                                                new CompStmt(new WriteHeapStmt("a", new ValueExp(new IntValue(1))),
                                                        new CompStmt(new WriteHeapStmt("b", new ValueExp(new IntValue(2))),
                                                                new CompStmt(new ConditionalAssignmentStmt("v", new RelationalExp(new ReadHeapExp(new VarExp("a")), new ReadHeapExp(new VarExp("b")), 1), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
                                                                        new CompStmt(new PrintStmt(new VarExp("v")),
                                                                                new CompStmt(new ConditionalAssignmentStmt("v", new RelationalExp(new ArithExp(new ReadHeapExp(new VarExp("b")), new ValueExp(new IntValue(2)), '-'), new ReadHeapExp(new VarExp("a")), 5), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
