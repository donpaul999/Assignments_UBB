...
public class ConditionalAssignmentStmt implements IStmt {
    ...
    public PrgState execute(PrgState state) throws StmtException, ExprException {
        ...
        IStmt st = new IfStmt(exp1, new AssignStmt(varName, exp2), new AssignStmt(varName, exp3));
    ...
    public IMyDictionary<String, Type> typecheck(IMyDictionary<String, Type> typeEnvironment) throws StmtException, ExprException {
        ...
        if (exp1Type.equals(new BoolType())) {
            ...
            if (exp2Type.equals(exp3Type)) {
                    return typeEnvironment;
            } else throw new StmtException("Exp2, Exp3 doesn't have the same type");
