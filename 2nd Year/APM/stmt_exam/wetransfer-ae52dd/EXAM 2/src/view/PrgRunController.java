...
public class PrgRunController implements Initializable {
    ...
    @FXML
    TableView<HashMap.Entry<Integer,Integer>> lockTableView;
    @FXML
    TableColumn<HashMap.Entry<Integer,Integer>,String> lockAddressTableColumn;
    @FXML
    TableColumn<HashMap.Entry<Integer,Integer>,String> lockIdentifierTableColumn;
    ...
    public void populateLockTable() {
        ...
        lockAddressTableColumn.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(Integer.toString(cellData.getValue().getKey())));
        lockIdentifierTableColumn.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(Integer.toString(cellData.getValue().getValue())));
        lockTableList.addAll(myController.getRepository().getPrgList().get(0).getLockTable().getContent().entrySet());
        lockTableView.setItems(lockTableList);
